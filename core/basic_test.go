...
func TestInt(t *testing.T) {
	...
	fail(t, val, err, "TypeMismatch: Expected Int or Float, not Str")
	val, err = NewInt(3).Sub(False)
	fail(t, val, err, "TypeMismatch: Expected Int or Float, not Bool")
	val, err = NewInt(3).Sub(Null)
	fail(t, val, err, "TypeMismatch: Expected Int or Float, not Null")
