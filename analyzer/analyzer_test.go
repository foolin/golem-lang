...
.   BlockNode(Scope defs:{})
.   .   ExprStmt
.   .   .   StructExpr(StructScope defs:{this: v(0: this,0,true,false)})
...
.   BlockNode(Scope defs:{})
.   .   ExprStmt
.   .   .   StructExpr(StructScope defs:{this: v(1: this,1,true,false)})
.   .   .   .   StructExpr(StructScope defs:{this: v(0: this,0,true,false)})
.   .   .   .   .   ThisExpr(v(0: this,0,true,false))
...
.   .   .   StructExpr(StructScope defs:{this: v(2: this,1,true,false)})
.   .   .   .   PropNode
